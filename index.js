...
var acs = document.getElementById('accessoriesCards')
...
for (let index = 0; index < 10; index++) {
  if (productList[index].isAccessory==false ) {
    ...
    na.innerHTML = productList[index].name
    var brand = document.createElement('h4')
    brand.innerHTML = productList[index].brand
    var value = document.createElement('h5')
    value.innerHTML = productList[index].price
    details.appendChild(na)
